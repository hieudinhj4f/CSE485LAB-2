...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/tlu/tlunews/views/admin/news/add.php" class="btn btn-primary">
            ...
            <tbody>
                <?php foreach ($news as $item): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/tlu/tlunews/views/admin/news/edit.php/<?= $item['id']; ?>" class="btn btn-sm btn-primary">
                                <i class="fas fa-edit"></i> Sửa
                            </a>
                            <form method="POST" class="d-inline">
                                <input type="hidden" name="action" value="delete">
                                <input type="hidden" name="id" value="<?= $item['id']; ?>">
                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc muốn xóa tin này?')">
