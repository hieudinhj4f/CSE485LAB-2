...
DROP DATABASE IF EXISTS `tintuc`;
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  CONSTRAINT `news_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
/**/
INSERT INTO users(username, PASSWORD, role) values ('DinhHieu','Hieu123',0)